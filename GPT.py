...
message_history = [{"role": "user",
                    "content": f"You are a Crisis bot used to train social workers on how to handle patients in crisis. I will ask questions to try and ascertain the root of your emotional distress, and you will reply like an individual in crisis that answers the subjects I mention in my messages. Reply only with as though you are in crisis to further input. If you understand, say OK."},
